...
import { formatearFechaCorta, formatearMoneda } from '../../utilities/formater/FormateadorModel';

export default function DataMensualidades({ mensualidades, loading, refreshing, refresh, handlePago }) {
        ...
        return (
            <View style={tw`flex-1 bg-gray-50`}>
                <View style={tw`flex-1 justify-center items-center`}>
                    ...
                    <Text style={tw`mt-4 text-gray-600`}>Cargando mensualidades...</Text>
                </View>
            </View>
        );
    }
                        ...
                        <View key={mensualidad.id} style={tw`bg-white rounded-xl shadow-sm mb-4 border border-gray-100`}>
                                    ...
                                    <View style={tw`flex-row items-center`}>
                                        ...
                                        <View>
                                            <Text style={tw`text-lg font-semibold text-gray-800`}>
                                                {formatearFechaCorta(mensualidad.fecha).charAt(0).toUpperCase() + formatearFechaCorta(mensualidad.fecha).slice(1)}
                                            </Text>
                            ...
                            <View style={tw`p-4`}>
                                <View style={tw`flex-row justify-between items-center mb-4`}>
                                        <Text style={tw`text-sm text-gray-500 mb-1`}>Valor mensualidad</Text>
