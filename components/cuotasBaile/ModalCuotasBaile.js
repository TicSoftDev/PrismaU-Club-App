...
export default function ModalCuotasBaile({ showPaymentModal, cerrarModal, cuota, loading, crearPreferencia,
                                ...
                                <View style={tw`border-t border-green-200 pt-4`}>
                                    ...
                                    <View style={tw`flex-row justify-between items-center`}>
                                        ...
                                        <Text style={[
                                            ...
                                            { color: cuota.restante > 0 ? '#dc2626' : '#16a34a' }
                                        ]}>
                                            {formatearMoneda(cuota.restante)}
                                        </Text>
                                    </View>
                                </View>
                            </View>
