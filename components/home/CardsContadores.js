...
export default function CardsContadores({ familiares, invitados }) {
    return (
        <View style={tw`px-4 pt-12 pb-5 w-full`}>
            <View style={tw`bg-white rounded-lg p-4 shadow-lg`}>
                <View style={tw`flex-row justify-between`}>
                    <View style={tw`flex-row justify-around items-center w-1/2 p-2 border-2 border-purple-500 rounded-lg mr-2`}>
                        <View style={tw`justify-center items-center rounded-full`}>
                            <FontAwesome5 name="users" size={32} color="#9061f9" />
                        </View>
                        <View style={tw`flex justify-end items-center`}>
                            <Text style={tw`mt-1 text-sm text-purple-600`}>Familiares</Text>
                            <Text style={tw`text-xl font-bold text-purple-600`}>{familiares}</Text>
                        </View>
                    </View>
